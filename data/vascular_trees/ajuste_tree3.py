import sys
import math
fp = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/pontos_tree3.txt")
pontos = [ map(float,line.split('\t')) for line in fp ]
fl = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/linhas_tree3.txt")
linhas1 = [ map(float,line.split('\t')) for line in fl ]
linhas2 = []
linhasFile = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/linhas2_tree3.txt", 'w+')
#for p1 in pontos:
#    for p2 in pontos:
#        if math.sqrt(math.pow(p1[0]-p2[0],2) + math.pow(p1[1]-p2[1],2) + math.pow(p1[2]-p2[2],2)) < 0.001 and p1 != p2:
#            print(p1)
#            print(p2)
