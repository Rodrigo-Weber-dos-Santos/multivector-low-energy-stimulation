import sys
import math
fp = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/pontos_tree2.txt")
pontos = [ map(float,line.split('\t')) for line in fp ]
fl = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/linhas_tree2.txt")
linhas1 = [ map(float,line.split('\t')) for line in fl ]
linhas2 = []
linhasFile = open("/home/bruno/Desktop/Artigo/ArvoresCoracao/linhas2_tree2.txt", 'w+')
#for p1 in pontos:
#    for p2 in pontos:
