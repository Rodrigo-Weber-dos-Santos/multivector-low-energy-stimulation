#ifndef MNASH_PANFILOV_H_
#define MNASH_PANFILOV_H_
...
class MyNashPanfilov : public CellModel
{
 public:
 ...
 private:
  ...
  double rateswitchNP(double V, double aux, double Vthreshold, double auxThreshold, double Ta);
