...
def _slope_triangle(origin, dx, dy, ec='0.0', fc='0.9', **poly_kwargs):
...
if __name__ == '__main__':
    plt.plot([0, 2], [0, 1]) 
    slope_marker((0.85, 0.3), (1, 2), size_frac=0.25, pad_frac=0.25)
    
    #x = np.logspace(0, 2)
    #fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2,2)
