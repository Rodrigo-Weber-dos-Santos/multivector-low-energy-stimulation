...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs Xx
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs Xx
...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs xY
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs xY
...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs Yy
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs Yy
...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs yZ
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs yZ
...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs Zz
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs Zz
...
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.01 -fs zX
"${MONODOMAIN}" -f "${MESH_DIR}/EsferaTree.xml" -dt 0.05 -t 100 -pr 1 -c TNNP -m ExplicitEuler -ep monodomain -fa 0.02 -fs zX
