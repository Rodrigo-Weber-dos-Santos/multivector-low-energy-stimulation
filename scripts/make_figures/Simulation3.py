...
imgV2 = mpimg.imread('simu2_t5.png')
imgV3 = mpimg.imread('simu2_t9.png')
imgV4 = mpimg.imread('simu2_t1_4v.png')
imgV5 = mpimg.imread('simu2_t5_4v.png')
imgV6 = mpimg.imread('simu2_t9_4v.png')
...
ax2.text(.05,.05,'t = 5 ms', horizontalalignment='left', verticalalignment='center',transform=ax2.transAxes, fontsize=9)
ax3 = fig.add_subplot(gs[0, 2], sharey=ax1)
ax3.text(.05,.95,'c', horizontalalignment='left', verticalalignment='top', transform=ax3.transAxes, weight='bold')
ax3.text(.05,.05,'t = 9 ms', horizontalalignment='left', verticalalignment='center', transform=ax3.transAxes, fontsize=9)
...
ax4.text(.05,.05,'t = 1 ms', horizontalalignment='left', verticalalignment='center',transform=ax4.transAxes, fontsize=9)
...
ax5.text(.05,.05,'t = 5 ms', horizontalalignment='left', verticalalignment='center',transform=ax5.transAxes, fontsize=9)
...
ax6.text(.05,.05,'t = 9 ms', horizontalalignment='left', verticalalignment='center',transform=ax6.transAxes, fontsize=9)
...
#plt.show()
plt.savefig("Simulation3.pdf", dpi=1200)
